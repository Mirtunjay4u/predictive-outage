...
/**
 * 19-step Executive Auto Tour — GTC-grade live demo sequence.
...
const tourSteps = [
  {
    ...
    route: '/login',
    duration: 28000,
    narrative: 'Establishing operator context via the Login page. The landing view provides immediate orientation to governed AI decision-support capabilities.',
    tooltip: 'This governed AI decision layer integrates deterministic policy enforcement with advisory-only operational analysis.',
  ...
  },
  {
    ...
    route: '/dashboard',
    duration: 38000,
    narrative: 'Reviewing active event KPIs, high-priority alerts, crew workload, Executive Signal, and the governance header strip.',
    tooltip: 'The Dashboard provides operational awareness combining risk scoring, event prioritization, and readiness tracking.',
  ...
  },
  {
    ...
    tooltip: 'All advisory insights are validated through explicit operational rules before output.',
  ...
  },
  {
    ...
    duration: 45000,
    narrative: 'Governed AI analysis of the Downtown Houston Storm event via the Nemotron inference layer. Reviewing guardrails and structured reasoning outputs.',
  ...
  },
  {
    ...
    tooltip: 'Operational analytics are derived from event data and deterministic rule-engine outputs.',
  ...
  },
  {
    ...
    route: '/architecture',
    duration: 30000,
    narrative: 'Exploring the system architecture — ingest layer, copilot orchestrator, guardrails, Nemotron inference, observability.',
  ...
  },
  {
    ...
    route: '/about',
    duration: 20000,
    narrative: 'Reviewing advisory-only governance, safety compliance, and the decision-support-only boundary.',
    tooltip: 'This system provides decision support only. All outputs require operator validation.',
  ...
  },
  {
    ...
    duration: 28000,
    narrative: 'Reviewing the Solution Evolution Blueprint — three-phase timeline with progress connectors, capability lanes, acceptance markers, and governance non-claims.',
    tooltip: 'Structured evolution plan aligned to utility operational governance and predictive validation milestones.',
    highlights: ['Phase Timeline', 'Capability Lanes', 'Acceptance Markers', 'Non-Claims'],
  ...
  },
  {
    ...
    duration: 22000,
    narrative: 'Reviewing operational governance rules, Phase-1 scope boundaries, and deterministic constraint definitions.',
  ...
  },
  {
    ...
    route: '/glossary',
    duration: 20000,
    narrative: 'Browsing standardized definitions for utility domain and AI terminology — regulator-ready reference for all stakeholders.',
  ...
  },
  {
    ...
    tooltip: 'This conceptual layer demonstrates future environmental intelligence capabilities — advisory only.',
  ...
  },
  {
    ...
    route: '/dashboard',
    duration: 30000,
    narrative: 'Completing the operational loop — confirming updated KPIs, stabilized posture, and narrative resolution. Governed AI · Advisory-Only · Operator Validation Required.',
    tooltip: 'The operational loop closes with updated KPIs, stabilized system posture, and version-stamped confidence.',
