...
import { formatDashboardTime } from '@/lib/dashboard';
...
export default function Dashboard() {
  ...
  return (
    <div className={cn('mx-auto max-w-[1600px]', boardroomMode ? 'px-6 py-7 lg:px-7' : 'px-4 py-5 lg:px-5')}>
      <header className="mb-4">
        <div className={cn('flex items-start justify-between gap-4 rounded-xl border border-border/60 bg-card shadow-sm', boardroomMode ? 'px-5 py-4' : 'px-4 py-3')}>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] text-muted-foreground">Updated {formatDashboardTime(dataUpdatedAt)}</span>
      ...
      <div className="grid grid-cols-12 items-start gap-4">
        ...
        <div className={cn('col-span-12', boardroomMode ? 'lg:col-span-12' : 'lg:col-span-6')}>
          <ExecutiveSignalCard
            ...
            onOpenSupportingSignals={() => setSupportingOpen(true)}
          />
          <div className={cn('grid gap-4', boardroomMode ? 'grid-cols-2 xl:grid-cols-3' : 'grid-cols-2 xl:grid-cols-3')}>
