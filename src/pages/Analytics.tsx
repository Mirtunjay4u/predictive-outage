    ...
    <div data-tour-section="analytics" className="p-4 lg:p-6">
      ...
      >
        ...
        <p className="text-xs text-muted-foreground">
          Analytics reflect rule-engine validated event states and deterministic policy outputs — not raw projections. Advisory only.
        </p>
      </motion.div>

      {/* ── 6 KPI Cards ── */}
      <div data-tour-section="analytics-kpis" className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-5 items-stretch">
      ...
      {/* ── 2 Compact Charts ── */}
      <div data-tour-section="analytics-charts" className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
